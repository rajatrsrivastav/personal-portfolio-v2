  ...
  return (
    <div className="fixed top-0 left-0 right-0 p-6 flex justify-between items-center bg-transparent z-50">
      ...
      <nav className="hidden md:flex items-center bg-white/10 backdrop-blur-xl rounded-full p-2">
        <a
          href="#"
          className="bg-white/90 text-black px-6 py-3 rounded-full text-sm transition-all duration-300"
        >
          Home
        </a>
        <a
      ...
      <div className="flex items-center gap-4">
        <a
          href="#"
          className="bg-white/10 border border-white/20 text-white px-6 py-3 rounded-full hover:bg-white/20 transition-all duration-300"
        >
          Book a Call
        </a>
      </div>
